...
#include "../OdPlatformSettings.h"
  ...
  #define GE_TOOLKIT_EXPORT     OD_TOOLKIT_EXPORT /* {Secret} */
  #define GE_STATIC_EXPORT      OD_STATIC_EXPORT  /* {Secret} */
#else
  #define GE_TOOLKIT_EXPORT     OD_TOOLKIT_IMPORT /* {Secret} */
  #define GE_STATIC_EXPORT      OD_STATIC_IMPORT  /* {Secret} */
#endif
