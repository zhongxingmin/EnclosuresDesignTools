...
*/
  ...
  /**
    ...
    Arguments:
    pFiler (I) Pointer to the OdDbDwgFiler *object*.
...
*/
	...
	static
    void outFields(OdDbDwgFiler* pFiler, const OdGePolyline2d& object);
...
*/
	...
	static
    void inFields(OdDbDwgFiler* pFiler, OdGePolyline2d& object);
