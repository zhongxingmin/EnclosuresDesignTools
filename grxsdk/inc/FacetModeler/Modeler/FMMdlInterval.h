#ifndef __FMMDL_INTERVAL_H__
#define __FMMDL_INTERVAL_H__

#include <limits.h>
#include "FMMdlPlane.h"
#include "FMMdlIntPoint2d.h"

namespace FacetModeler
{
  class FMGEOMETRY_API Interval1d
  {
  public:
    ...
    Interval1d(double a, double b, int /*v*/)
      : lower(a), upper(b) 
    {}
  ...
  class FMGEOMETRY_API Interval2d
  {
  public:
    ...
    Interval2d(Point2d a, Point2d b, int /*v*/) : lower(a), upper(b)
    {}
  ...
  {
    return (interv.lower.x <= p.x && 
      p.x <= interv.upper.x &&
      interv.lower.y <= p.y && p.y <= interv.upper.y);
  }

  class FMGEOMETRY_API Interval3d
  {
  public:
    Interval3d()
    { 
    ...
    Interval3d(Point3d a, Point3d b, int /*v*/) : lower(a), upper(b)
    {}
  ...
  class FMGEOMETRY_API IntInterval1d
  {
  public:
    ...
    IntInterval1d(int a, int b, int /*v*/) : lower(a), upper(b) 
    {}
  ...
  class FMGEOMETRY_API IntInterval2d
  {
  public:
    ...
    IntInterval2d(IntPoint2d a, IntPoint2d b, int /*v*/) : lower(a), upper(b) 
    {}
    ...
    { 
      return IntPoint2d((upper.x + lower.x) / 2,
      (upper.y + lower.y) / 2); 
    }
  ...
  class FMGEOMETRY_API IntInterval3d
  {
  public:
    ...
    IntInterval3d(IntPoint3d a, IntPoint3d b, int /*v*/) : lower(a), upper(b) 
    {}
    ...
    { 
      return IntPoint3d((upper.x + lower.x) / 2,
      (upper.y + lower.y) / 2,
      (upper.z + lower.z) / 2); 
    }
